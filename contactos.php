...
<?php
    ...
    con.apellido AS apellido, con.telefono AS telefono, con.email AS email, con.categoria AS categoria_id FROM categorias cat INNER JOIN contactos con ON con.categoria = cat.id";
                ...
                <?php foreach($contactos as $fila) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="borrar_contacto.php?id=<?php echo $fila->id; ?>&idCategoria=<?php echo $fila->categoria_id; ?>" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Borrar</a>
                        </td>
                    </tr> 
                <?php endforeach;  ?>                                        
                </tbody>       
